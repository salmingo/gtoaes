...
protected:
	...
	boost::mutex mtx_tcp_focus_;	//< 互斥锁: 调焦
	boost::mutex mtx_tcp_annex_;	//< 互斥锁: 附属(雨量+天窗)
	TcpSPtr tcps_client_;	//< 服务器: 用户
	TcpSPtr tcps_mount_;	//< 服务器: 转台
	TcpSPtr tcps_camera_;	//< 服务器: 相机
	TcpSPtr tcps_focus_;	//< 服务器: 调焦
...
//////////////////////////////////////////////////////////////////////////////
	 ...
	 * @param ec  错误代码. 0: 正确
	 */
	void receive_focus(const long ptr, const long ec);
	/*!
	 * @brief 处理附属设备信息
	 * @param ptr 网络资源
	 * @param ec  错误代码. 0: 正确
	 ...
	 * @param proto  信息主体
	 */
	void process_protocol_focus(annpbase proto);
	/*!
	 * @brief 处理来自附属设备的网络信息
	 * @param proto 信息主体
	 */
	void process_protocol_annex(annpbase proto);
	/*!
	 * @brief 启动自动观测工作逻辑
	 */
